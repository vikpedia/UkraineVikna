...
Public Class Demo
    ...
    Private Sub DataLoad()
        ...
        Dim Query1 As String = "Select * From tblPassengers Where USerID=@uid"
        Dim comm1 As New SqlCommand(Query1, conn)
        comm1.Parameters.AddWithValue("@uid", Session("userid"))
    ...
    Private Sub DataLoad1()
        ...
        Dim Query2 As String = "Select * From tblBooking Where UID=@uid"
    ...
    Private Sub DataLoad2()
        ...
        'select seat details
        Dim Query3 As String = "Select * From tblSeat Where UID=@uid"
